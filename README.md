...
- **Smooth pan & zoom** — click-drag to pan both axes, scroll wheel to zoom, kinetic scrolling
...
- **Drawing tools** — trend lines, extended lines, horizontal lines, text annotations
